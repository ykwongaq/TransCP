...
output_dir = "/mnt/hdd/davidwong/models/TransCP/intra_level_no_negative_val_seen"

test_split = "intra_class_val_seen_no_negative"

checkpoint = "/mnt/hdd/davidwong/models/TransCP/marinedet_intra_class_train_no_negative/checkpoint_best_acc.pth"
batch_size_test = 16
