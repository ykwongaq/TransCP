...
output_dir = (
    "/mnt/hdd/davidwong/models/TransCP/inter_class_val_unseen_no_negative_no_trained"
)

test_split = "inter_class_val_unseen_no_negative"

checkpoint = "/mnt/hdd/davidwong/models/TransCP/pretrained/checkpoint_best_acc.pth"
batch_size_test = 16
