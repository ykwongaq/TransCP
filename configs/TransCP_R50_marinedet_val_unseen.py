...
output_dir = "/mnt/hdd/davidwong/models/TransCP/class_level_no_negative_val_unseen"

test_split = "class_level_val_unseen_no_negative"

checkpoint = (
    "/mnt/hdd/davidwong/models/TransCP/class_level_no_negative/checkpoint_best_acc.pth"
)
batch_size_test = 16
